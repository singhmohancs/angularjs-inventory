 ...
 */
var proxyTarget = 'https://api.inventory.com/'; //http://server/context/';
...
function proxyMiddleware(req, res, next) {
     ...
     */
    if (/\.(html|css|js|png|jpg|jpeg|gif|ico|xml|rss|txt|eot|svg|ttf|woff|woff2|cur|json|map)(\?((r|v|rel|rev)=[\-\.\w]*)?)?$/.test(req.url) || (req.url.indexOf('/api') === -1)) {
        next();
    } else {
